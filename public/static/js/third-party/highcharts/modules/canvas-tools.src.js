  ...
  function build () {
    ...
    svg.BoundingBox = function (x1, y1, x2, y2) { // pass in initial points if you want
      ...
      this.addBezierCurve = function (p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
        ...
        var p0 = [p0x, p0y]; var p1 = [p1x, p1y]; var p2 = [p2x, p2y]; var p3 = [p3x, p3y]
...
(function (Highcharts) { // encapsulate
  ...
  var CanVGRenderer = Highcharts.CanVGRenderer
  var SVGRenderer = Highcharts.SVGRenderer
  var extend = Highcharts.extend
  var merge = Highcharts.merge
  var addEvent = Highcharts.addEvent
  var createElement = Highcharts.createElement
  var discardElement = Highcharts.discardElement
  ...
  extend(CanVGRenderer.prototype, {
    ...
    configure: function (chart) {
      var renderer = this
      var options = chart.options.tooltip
      var borderWidth = options.borderWidth
      var tooltipDiv = renderer.ttDiv
      var tooltipDivStyle = options.style
      var tooltipLine = renderer.ttLine
      var padding = parseInt(tooltipDivStyle.padding, 10)
      ...
      addEvent(chart, 'tooltipRefresh', function (args) {
        ...
        var offsetLeft = chartContainer.offsetLeft
