...
(function (Highcharts) {
  ...
  Highcharts.extend(Data.prototype, {
    ...
    getColumnDistribution: function () {
      ...
      var getValueCount = function (type) {
        return (Highcharts.seriesTypes[type || 'line'].prototype.pointArrayMap || [0]).length
      }
      var globalType = chartOptions && chartOptions.chart && chartOptions.chart.type
    ...
    parseCSV: function () {
      ...
      var endRow = options.endRow || Number.MAX_VALUE
      var startColumn = options.startColumn || 0
      var endColumn = options.endColumn || Number.MAX_VALUE
      var lines
      var activeRowNo = 0
    ...
    parseGoogleSpreadsheet: function () {
      var self = this
      var options = this.options
      var googleSpreadsheetKey = options.googleSpreadsheetKey
      var columns = this.columns
      var startRow = options.startRow || 0
      var endRow = options.endRow || Number.MAX_VALUE
      var startColumn = options.startColumn || 0
