...
(function (H) {
  ...
  var ColumnSeries = seriesTypes.column
  var fireEvent = HighchartsAdapter.fireEvent
  ...
  Chart.prototype.addSeriesAsDrilldown = function (point, ddOptions) {
    ...
    var xAxis = oldSeries.xAxis
    var yAxis = oldSeries.yAxis
    var newSeries
    var color = point.color || oldSeries.color
    var pointIndex
    var level
  ...
  Chart.prototype.showDrillUpButton = function () {
    var chart = this
    var backText = this.getDrilldownBackText()
    var buttonOptions = chart.options.drilldown.drillUpButton
  ...
  Chart.prototype.drillUp = function () {
    var chart = this
    var level = chart.drilldownLevels.pop()
    var oldSeries = chart.series[0]
    var oldExtremes = level.oldExtremes
    var newSeries = chart.addSeries(level.seriesOptions, false)
  ...
  PieSeries.prototype.animateDrilldown = function (init) {
    ...
    var start = animateFrom.start
    var angle = animateFrom.end - start
    var startAngle = angle / this.points.length
    var startColor = H.Color(level.color).rgba
  ...
  PieSeries.prototype.animateDrillupTo =
			ColumnSeries.prototype.animateDrillupTo = function (init) {
			  if (!init) {
			    var newSeries = this
			    var level = newSeries.drilldownLevel
  ...
  ColumnSeries.prototype.animateDrillupFrom =
	...
	function (level) {
	  ...
	  each(this.points, function (point) {
	    ...
	    var startColor = H.Color(point.color).rgba
  ...
  wrap(H.Point.prototype, 'init', function (proceed, series, options, x) {
    ...
    var chart = series.chart
    var tick = series.xAxis && series.xAxis.ticks[x]
    var tickLabel = tick && tick.label
