...
// create shortcuts
  ...
  var doc = document
  var win = window
  var isTouchDevice = Highcharts.isTouchDevice
  var M = 'M'
  var L = 'L'
  var DIV = 'div'
  var HIDDEN = 'hidden'
  ...
  var PX = 'px'
  var UNDEFINED
  var symbols = Highcharts.Renderer.prototype.symbols
  ...
  extend(Chart.prototype, {
    ...
    getSVG: function (additionalOptions) {
      ...
      var cssWidth
      var cssHeight
      var options = merge(chart.options, additionalOptions) // copy the options and add extra options
    ...
    contextMenu: function (className, items, x, y, width, height, button) {
      ...
      var menuItemStyle = navOptions.menuItemStyle
      var chartWidth = chart.chartWidth
      var chartHeight = chart.chartHeight
      var cacheName = 'cache-' + className
      var menu = chart[cacheName]
      var menuPadding = mathMax(width, height) // for mouse leave detection
      var boxShadow = '3px 3px 10px #888'
      var innerMenu
      var hide
      var hideTimer
      var menuStyle
    ...
    addButton: function (options) {
      ...
      var select = states && states.select
      var callback
