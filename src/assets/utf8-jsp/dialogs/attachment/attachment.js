...
(function () {
  ...
  function initButtons () {
    dialog.onok = function () {
      var list = []; var id; var tabs = $G('tabhead').children
      for (var i = 0; i < tabs.length; i++) {
  ...
  UploadFile.prototype = {
    ...
    getInsertList: function () {
      var i; var link; var data; var list = []
  ...
  OnlineFile.prototype = {
    ...
    pushData: function (list) {
      var i; var item; var img; var filetype; var preview; var icon; var _this = this
    ...
    getInsertList: function () {
      var i; var lis = this.list.children; var list = []
