...
(function () {
  ...
  function setTabFocus (id) {
    if (!id) return
    var i; var bodyId; var tabs = $G('tabhead').children
  ...
  function initButtons () {
    dialog.onok = function () {
      var remote = false; var list = []; var id; var tabs = $G('tabhead').children
      for (var i = 0; i < tabs.length; i++) {
  ...
  RemoteImage.prototype = {
    ...
    setPreview: function () {
      var url = $G('url').value
      var ow = parseInt($G('width').value, 10) || 0
      var oh = parseInt($G('height').value, 10) || 0
      var border = parseInt($G('border').value, 10) || 0
  ...
  UploadImage.prototype = {
    ...
    initUploader: function () {
      ...
      // 上传按钮
      var $filePickerBtn = $wrap.find('.filePickerBtn')
      // 上传按钮
      var $filePickerBlock = $wrap.find('.filePickerBlock')
      // 没选择文件之前的内容。
    ...
    getQueueCount: function () {
      var file; var i; var status; var readyFile = 0; var files = this.uploader.getFiles()
  ...
  OnlineImage.prototype = {
    ...
    pushData: function (list) {
      var i; var item; var img; var icon; var _this = this
    ...
    getInsertList: function () {
      var i; var lis = this.list.children; var list = []; var align = getAlign()
  ...
  SearchImage.prototype = {
    ...
    getImageData: function () {
      ...
      var url = 'http://image.baidu.com/i?ct=201326592&cl=2&lm=-1&st=-1&tn=baiduimagejson&istype=2&rn=32&fm=index&pv=&word=' + _this.encodeToGb2312(key) + type + '&keeporiginname=' + keepOriginName + '&' + +new Date()
    ...
    setList: function (list) {
      var i; var item; var p; var img; var link; var _this = this
