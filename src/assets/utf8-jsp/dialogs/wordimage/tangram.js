...
baidu.each = baidu.array.forEach = baidu.array.each = function (source, iterator, thisObject) {
  var returnValue; var item; var i; var len = source.length
...
baidu.swf.createHTML = function (options) {
  ...
  var vUnit1; var vUnit2; var i; var k; var len; var item; var tmpOpt = {}
...
baidu.lang.toArray = function (source) {
  ...
  if (source.item) {
    var l = source.length; var array = new Array(l)
...
baidu.swf.getMovie = function (name) {
  var movie = document[name]; var ret
...
baidu.sio.log = function (url) {
  var img = new Image()
  var key = 'tangram_sio_log_' + Math.floor(Math.random() *
