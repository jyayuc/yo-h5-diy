...
vjs.CDN_VERSION = '4.3'
vjs.ACCESS_PROTOCOL = (document.location.protocol == 'https:' ? 'https://' : 'http://')
...
vjs.Player.prototype.paused = function () {
  ...
  return this.techGet('paused') !== false
}
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function (player, options, ready) {
    ...
    var placeHolder = this.el_ = vjs.createEl('div', { id: player.id() + '_temp_flash' })
    ...
    var params = vjs.obj.merge({
      wmode: 'opaque', // Opaque is needed to overlay controls, but can affect playback performance
      bgcolor: '#000000' // Using bgcolor prevents a white flash when the object is loading
    }, options.params)

    // Merge default attributes with ones passed in
    var attributes = vjs.obj.merge({
      id: objId,
...
var readWrite = 'rtmpConnection,rtmpStream,preload,currentTime,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,controller,controls,volume,muted,defaultMuted'.split(',')
...
vjs.Flash.embed = function (swf, placeHolder, flashVars, params, attributes) {
  ...
  var obj = vjs.createEl('div', { innerHTML: code }).childNodes[0]
...
vjs.Player.prototype.showTextTrack = function (id, disableSameKind) {
  ...
  var i = 0
  var j = tracks.length
  var track; var showTrack; var kind
  ...
  kind = (showTrack) ? showTrack.kind() : ((disableSameKind) || false)
...
vjs.TextTrack.prototype.parseCueTime = function (timeText) {
  ...
  var time = 0
  var hours; var minutes; var other; var seconds; var ms
...
vjs.TextTrack.prototype.update = function () {
  if (this.cues_.length > 0) {
    ...
    if (this.prevChange === undefined || time < this.prevChange || this.nextChange <= time) {
      ...
      var newNextChange = this.player_.duration() // Start at beginning of the timeline
      var newPrevChange = 0 // Start at end

      var reverse = false // Set the direction of the loop through the cues. Optimized the cue check.
      var newCues = [] // Store new active cues.

      // Store where in the loop the current active cues are, to provide a smart starting point for the next loop.
      var firstActiveIndex; var lastActiveIndex
      var cue; var i // Loop vars
...
vjs.OffTextTrackMenuItem.prototype.update = function () {
  ...
  var i = 0; var j = tracks.length; var track
  var off = true
...
vjs.ChaptersButton.prototype.createMenu = function () {
  ...
  if (chaptersTrack) {
    var cues = chaptersTrack.cues_; var cue; var mi
    i = 0
    j = cues.length
...
vjs.autoSetup = function () {
  var options; var vid; var player
