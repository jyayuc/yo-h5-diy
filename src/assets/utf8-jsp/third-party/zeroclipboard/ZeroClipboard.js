...
(function (window) {
  ...
  var _swfPath = (function () {
    var i; var jsDir; var tmpJsPath; var jsPath; var swfPath = 'ZeroClipboard.swf'
  ...
  var _camelizeCssPropName = (function () {
    var matcherRegex = /\-([a-z])/g; var replacerFn = function (match, group) {
    ...
    if (value && typeof value === 'string') {
      ...
      if (element.nodeType === 1) {
        if (!element.className) {
          ...
          var className = ' ' + element.className + ' '; var setClass = element.className
  ...
  var _getZoomFactor = function () {
    var rect; var physicalWidth; var logicalWidth; var zoomFactor = 1
  ...
  var _vars = function (options) {
    var i; var len; var domain; var domains; var str = ''; var trustedOriginsExpanded = []
  ...
  var _extend = function () {
    var i; var len; var arg; var prop; var src; var copy; var target = arguments[0] || {}
  ...
  var _detectFlashSupport = function () {
    var plugin; var ax; var mimeType; var hasFlash = false; var isActiveX = false; var isPPAPI = false; var flashVersion = ''
  ...
  var _getAllClients = function () {
    var i; var len; var client; var clients = []; var clientIds = _objectKeys(_clientMeta)
  ...
  var _dispatchClientCallbacks = function (event, async) {
    ...
    if (handlers && handlers.length) {
      var i; var len; var func; var context; var originalContext = this
  ...
  var _preprocessEvent = function (event) {
    ...
    switch (event.type) {
      ...
      case 'copy':
        var textContent; var htmlContent; var targetEl = event.relatedTarget
  ...
  ZeroClipboard.prototype.on = function (eventName, func) {
    var i; var len; var events; var added = {}; var handlers = _clientMeta[this.id] && _clientMeta[this.id].handlers
  ...
  ZeroClipboard.prototype.off = function (eventName, func) {
    var i; var len; var foundIndex; var events; var perEventHandlers; var handlers = _clientMeta[this.id] && _clientMeta[this.id].handlers
  ...
  ZeroClipboard.prototype.handlers = function (eventName) {
    var prop; var copy = null; var handlers = _clientMeta[this.id] && _clientMeta[this.id].handlers
    if (handlers) {
      if (typeof eventName === 'string' && eventName) {
  ...
  var _getAllClientsClippedToElement = function (element) {
    var elementMetaId; var clientIds; var i; var len; var client; var clients = []
